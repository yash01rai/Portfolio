...
const NAV_LINKS = ["Home", "Work", "Experience", "Resume"];
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-4 md:pt-6 px-4 pointer-events-none">
      ...
      >
        ...
        <a 
          href="#"
          className="group relative flex items-center justify-center w-9 h-9 rounded-full transition-transform duration-300 hover:scale-110 ml-1"
        >
        ...
        <a
          ...
          className="group relative inline-flex items-center justify-center text-xs sm:text-sm text-text-primary mr-1"
        >
          ...
          <div className="relative flex items-center gap-1.5 bg-surface rounded-full px-3 sm:px-4 py-1.5 sm:py-2 backdrop-blur-md">
            Say hi
